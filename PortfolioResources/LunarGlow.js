		...
		return new THREE.ShaderMaterial({
			...
			fragmentShader:[
				...
				'void main() {',
					...
					'float dist = distl;',
					'vec4 light = vec4( dist, dist, dist, 1.0);',
		...
		return new THREE.ShaderMaterial({
			...
			fragmentShader:[
				...
				'void main() {',
					...
					'gl_FragColor = vec4(dist+0.17, dist+0.17, dist+0.17, pow(dist, 1.1)) * texture2D( texture, gl_PointCoord ).rgba;',
					THREE.ShaderChunk[ "fog_fragment" ],
